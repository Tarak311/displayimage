...
builder& builder::loadimage(std::string path){cv::Mat img_temp = cv::imread(path, cv::IMREAD_COLOR);image immm;this->imagebuild=&immm;this->imagebuild->img = img_temp;return *this;}
